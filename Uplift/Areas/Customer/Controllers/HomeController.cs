...
namespace Uplift.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var serviceFromDb = _unitOfWork.Service.GetFirstOrDefault(includeProperties: "Category,Frequency", filter: s => s.Id == id);
        ...
        public IActionResult AddToCart(int serviceId)
        {
            ...
            {
                //have to retrive the session
                //convert it to a list
                //append the new service to the list and then
